(function(e, t) {
  ...
  function(e) {
    ...
    var e = "www.sfht.com",
      ...
      o = {
        404: "http://" + s + "/404.html",
        activated: "http://" + s + "/activated.html",
        agreement: "http://" + s + "/agreement.html",
        center: "http://" + s + "/center.html",
        gotopay: "http://" + s + "/gotopay.html",
        index: "http://" + s + "/index.html",
        login: "http://" + s + "/login.html",
        nullactivated: "http://" + s + "/nullactivated.html",
        order: "http://" + s + "/order.html",
        orderdetail: "http://" + s + "/orderdetail.html",
        orderlist: "http://" + s + "/orderlist.html",
        passwordchange: "http://" + s + "/password-change.html",
        preheat: "http://" + s + "/preheat.html",
        process: "http://" + s + "/process.html",
        register: "http://" + s + "/register.html",
        retrieve: "http://" + s + "/retrieve.html",
        ilogin: "http://" + s + "/i.login.html",
        iregister: "http://" + s + "/i.register.html"
      };
    return {
      setting: {
        none_append_word: t,
