...
FastClick.prototype.needsClick = function(e) {
  ...
  function(e) {
    ...
    var a = -360,
      ...
      h = [a, f, l, c];
    n.route.ready();
    var p = e.fn.cookie("_aid"),
      d = function() {
        var t = n.route.attr();
        t.cookieInfo && e.fn.cookie(p + "_uinfo", t.cookieInfo), t.appId && (v._aid = t.appId, e.fn.cookie("_aid", t.appId, {
          path: "/",
          domain: ".sfht.com"
        })), t.csrfToken && (s.set("csrfToken", t.csrfToken), e.fn.cookie(v._aid + "_ct", 1, {
          path: "/",
          domain: ".sfht.com"
        })), t.token && e.fn.cookie(v._aid + "_tk", window.decodeURIComponent(t.token), {
          path: "/",
          domain: ".sfht.com"
        }), t.deviceId && e.fn.cookie("__da", t.deviceId, {
          path: "/",
          domain: ".sfht.com"
        })
      },
      v = n.Construct.extend({
        api: {},
        buildRequestData: function() {
          if (this.api) {
            this.fixture = !1, this.data && this.data.fixture && (this.fixture = !0);
            var e = {};
            r.extend(e, {
        ...
        checkUserLogin: function() {
          ...
          return !!e.fn.cookie(v._aid + "_ct") && !!t
        },
        goToLogin: function() {
        ...
        request: function(t, r) {
          var i = n.Deferred(),
            s = this,
            u = function(e) {
              e && e.stat && (s.serverTime = e.stat.systime), s.access(e, r) ? (s.afterRequest(t._mt, e.content[0]), i.resolve(e.content[0])) : e.stat.stateList.length == 0 ? i.reject(e.stat.code) : i.reject(e.stat.stateList[0].code, e.stat.stateList[0].msg)
            },
            a = function(e) {
              i.reject(e)
            };
