    ...
    function(can, $, cookie, touch, store, Fastclick, _, md5, SFComm, SFConfig, SFFn, ZfullPage, SFWeixin, SFReceiveCoupon, SFSwitcher, jweixin, SFHybrid, PageResponse) {
        ...
        var young = can.Control.extend({
            ".people .btn click": function() {
                ...
                var imgUrl = '../img/81/photo/' + (freshNum - index) + '/' + '1.jpg'
            ...
            init: function(element, options) {
                ...
                $('.tab li').click(function() {
                    ...
                    $('.people>li').eq(freshNum - 1 - index).find('img').attr('src', '../img/81/photo/' + people_index + '/' + photo_index + '.jpg');
            ...
            ".page3-r2  .a1 click": function() {
                ...
                $('.people>li').eq(voteNo - 1).find('img').attr('src', '../img/81/photo/' + voteNo + '/' + tabIndex + '.jpg');
            ...
            initActiveTab: function(tickets, Num, index) {
                if (tickets >= mi) {
                    ...
                    $('.people>li').eq(freshNum - 1 - index).find('img').attr('src', '../img/81/photo/' + Num + '/' + 4 + '.jpg');
                    ...
                    $('.people>li').eq(freshNum - 1 - index).find('img').attr('src', '../img/81/photo/' + Num + '/' + 3 + '.jpg');
                    $('.people>li').eq(freshNum - 1 - index).find('.people-lock').hide(); //去掉蒙层
                } else if (tickets >= xiaoXiu) {
                    $(".tab li").eq(1).addClass('active').siblings().removeClass('active');
                    $('.people>li').eq(freshNum - 1 - index).find('img').attr('src', '../img/81/photo/' + Num + '/' + 2 + '.jpg');
                    $('.people>li').eq(freshNum - 1 - index).find('.people-lock').hide(); //去掉蒙层
                } else {
                    $(".tab li").eq(0).addClass('active').siblings().removeClass('active');
                    $('.people>li').eq(freshNum - 1 - index).find('img').attr('src', '../img/81/photo/' + Num + '/' + 1 + '.jpg');
                    $('.people>li').eq(freshNum - 1 - index).find('.people-lock').hide(); //去掉蒙层
                }
            },
