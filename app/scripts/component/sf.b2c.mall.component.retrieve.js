...
define('sf.b2c.mall.component.retrieve', [
    'zepto',
    'can',
    'md5',
    'underscore',
  ...
  function($, can, md5, _, store, SFFrameworkComm, SFApiUserDownSmsCode, SFApiUserCheckSmsCode, SFApiUserResetPassword, SFApiUserSendResetPwdLink, SFBizConf) {
